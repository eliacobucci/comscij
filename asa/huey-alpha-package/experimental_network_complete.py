...
class ExperimentalNetwork:
    ...
    def __init__(self, window_size=5, max_neurons=100):
        ...
        # Sparse connectivity parameters (brain-like)
        self.max_connections_per_neuron = 150  # Like cortical neurons
        self.connection_probability = 0.15  # Only 15% of possible connections
        ...
        print(f"   Expected ~{self.connection_probability*100:.0f}% connectivity vs 100% in dense networks")
    ...
    def _should_create_connection(self, neuron_i, neuron_j):
        ...
        # Check if source neuron has reached connection limit
        if len(self.neuron_connections[neuron_i]) >= self.max_connections_per_neuron:
            return False
            
        # Probabilistic connection formation (brain-like sparsity)
