#!/usr/bin/env python3
"""
Huey||: Conversational Self-Concept Analysis System with Threaded Acceleration
...
from huey_parallel_network_complete import ExperimentalNetwork
import json
import re
...
class HueyConversationalNetwork(ExperimentalNetwork):
    ...
    def __init__(self, max_neurons=100, window_size=7, learning_rate=0.15, use_fortran_acceleration=True):
        # Use sliding windows for natural concept competition
        super().__init__(window_size=window_size, max_neurons=max_neurons, use_fortran_acceleration=use_fortran_acceleration)  
...
def run_conversational_self_concept_experiment():
    ...
    # Enable HueyTime temporal learning
    net.enable_temporal_learning(method="lagged", max_lag=8, tau=3.0)
