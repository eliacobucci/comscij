...
A user-friendly web interface for the Huey|| Hebbian Self-Concept Analysis Platform with threaded acceleration.

Copyright (c) 2025 Emary Iacobucci and Joseph Woelfel. All rights reserved.

Run with: streamlit run huey_parallel_web_interface.py
"""
...
try:
    from huey_parallel_complete_platform import HueyCompletePlatform
